...
void oscEvent(OscMessage msg) {
  ...
  println("wristR_x" + " : " + msg.get(0).floatValue() + "   ,   " + "wristR_y" + " : " + msg.get(1).floatValue());
  println("elbowR_x" + " : " + msg.get(2).floatValue() + "   ,   " + "elbowR_y" + " : " + msg.get(3).floatValue());
  println("neck_x" + " : " + msg.get(4).floatValue() + "   ,   " + "neck_y" + " : " + msg.get(5).floatValue());
